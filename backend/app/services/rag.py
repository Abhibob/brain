...
from app.models import Class, Enrollment, Material, MaterialSection, PersonalizedLesson, StudentProfileEntry
...
def build_personalization_prompt(profile_chunks: list[str], material: Material) -> str:
    return (
...
async def personalize_lesson(student_id: int, material_id: int, db: AsyncSession) -> PersonalizedLesson | None:
    ...
    prompt = build_personalization_prompt(profile_chunks, material)
